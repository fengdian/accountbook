 ...
 *
 * @fileName DeleteTreasure
 * @date on 2017/12/7 19:50
 */

public class DeleteTreasure implements INetService {
    @Override
    public String deal(NanoHTTPD.IHTTPSession session) {
        ...
        try {
            Map<String, Object> res = TreasureService.deleteTreasure(treasureId);
